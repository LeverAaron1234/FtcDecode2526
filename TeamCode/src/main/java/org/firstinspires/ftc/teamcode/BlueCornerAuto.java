...
@Autonomous
public final class BlueCornerAuto extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            Actions.runBlocking(new SequentialAction(
                    ...
                    drive.actionBuilder(new Pose2d(-60, 20, Math.toRadians(17)))
                            .strafeToSplineHeading(new Vector2d(-77,20),Math.toRadians(90))
                            .strafeTo(new Vector2d(-77, 55))
                            .build()
            ));
            ...
            Actions.runBlocking(new SequentialAction(
                    drive.actionBuilder(new Pose2d(-77,55,Math.toRadians(90)))
                            .strafeToSplineHeading(new Vector2d(-60, 20), Math.toRadians(17))
                            .build()
            ));
