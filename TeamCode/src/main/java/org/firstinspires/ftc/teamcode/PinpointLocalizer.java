...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3592.268592676243; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4102.722830580331; // x position of the perpendicular encoder (in tick units)
    }
